...
frame = cv2.imread('/home/pi/Pictures/testpic3.jpg')
...
print("[INFO] Done view image...")
print("[INFO] Close with ctrl + Q")
print('Known Faces in the Picture:', extract_names(names))
while True:
